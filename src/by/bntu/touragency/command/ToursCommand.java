...
/**
 * Class-command check user for role, create Order table, Users table & Car
 * table
 */
public class ToursCommand implements Command {

  private static org.apache.log4j.Logger logger = Logger.getLogger(ToursCommand.class);
  ...
  public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
      ...
      request.setAttribute("pageHeader", "tours for book");
      page = ConfigurationManager.getInstance().getProperty(ConfigurationManager.TOURS_PAGE_PATH);
    } catch (Exception e) {
